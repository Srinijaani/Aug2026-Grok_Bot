...
A static briefing dashboard for **Anysphere, Inc. (Cursor)** covering valuation, ARR, headcount, product releases on a time axis, and the SpaceX merger share spread.
...
No build step. Underlying series also live in `data/cursor-metrics.json`.
...
| Headcount | Founding team through merger close, with ARR per employee |
| Revenue mix | Enterprise vs individual share of ARR |
| Revenue multiple | EV / ARR at each priced mark |
| Share holding spread | SpaceX 8-K conversion of Cursor equity into SPCX Class A, RSUs, and options |
| Releases | Time-scaled swimlane plus a filterable product / model / funding / M&A list |
...
Implied 7-day VWAP = $60.0B ÷ 389,289,254 ≈ **$154.13**. The pre-close founder/investor mix tab is Dealroom’s public estimate, not a filed cap table. Employee equity (**16.2%** fully diluted) is the slice derived from the 8-K award conversions.

## Notes

- May 2026 ARR uses Bloomberg’s **$3.0B** (also cited by Wikipedia). Sacra’s **$4.0B** estimate is footnoted, not plotted as the primary series.
